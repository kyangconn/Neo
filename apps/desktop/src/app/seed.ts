...
export async function seedLunaWorldbook() {
  ...
  const wb: Worldbook = {
    ...
    description:
      "A living library at the crossroads of worlds, tended by Luna for centuries. Contains shifting architecture, self-writing books, and a cat that may or may not exist.",
