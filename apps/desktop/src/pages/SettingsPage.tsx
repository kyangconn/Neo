...
} from "@/features/billing/deepseek-billing";
...
type SectionDef = { key: Section; icon: typeof Plug; label: string };
...
export function SettingsPage() {
  ...
  const compressorSelectValue =
    memoryCompressorConfigId && modelConfigs.some((c) => c.id === memoryCompressorConfigId)
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between gap-4 rounded-md border px-3 py-3">
                        <div className="min-w-0">
                          ...
                          <p className="mt-1 text-xs text-muted-foreground">
                            When reply text matches world book keywords, send those entries to the secondary API for
                            visual details.
                          </p>
                        </div>
                        <SwitchButton
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <Button
                        ...
                        disabled={
                          testingComfyConnection || testingComfyImage || !imageGeneration.comfyWorkflowJson.trim()
                        }
                      >
