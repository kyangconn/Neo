...
export function CharacterPage() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden">
      <div className="shrink-0 border-b px-6 py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button size="icon" variant="ghost" className="h-8 w-8" onClick={() => fileInputRef.current?.click()} disabled={importing} title="Import character card">
      ...
      <Dialog open={detailOpen} onOpenChange={(open: boolean) => { if (open) setDetailOpen(true); else closeDetail() }}>
