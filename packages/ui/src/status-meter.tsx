...
export function StatusMeter({
  ...
  return (
    <div
      className={cn(
        'rounded-md border bg-background/78 px-3 py-2 shadow-sm',
    ...
    >
      ...
      {description && !compact && <p className="line-clamp-2 text-[11px] leading-relaxed text-muted-foreground">{description}</p>}
    </div>
  )
}
